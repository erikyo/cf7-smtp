...
/* harmony export */   "formElem": function() { return /* binding */ formElem; },
/* harmony export */   "responseBox": function() { return /* binding */ responseBox; },
/* harmony export */   "smtpAdmin": function() { return /* binding */ smtpAdmin; }
/* harmony export */ });
...
/* harmony import */ var _mailFetch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mailFetch */ "./src/scripts/mailFetch.js");
/* harmony import */ var _output__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./output */ "./src/scripts/output.js");
/**
...
_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default().createNonceMiddleware(window.smtp_settings.nonce));
...
function smtpAdmin() {
  ...
  if (page === 'wpcf7-integration' && service === 'cf7-smtp' && action === 'setup') {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchAndRetry": function() { return /* binding */ fetchAndRetry; },
/* harmony export */   "getSmtpLog": function() { return /* binding */ getSmtpLog; }
/* harmony export */ });
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/api-fetch */ "@wordpress/api-fetch");
/* harmony import */ var _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _output__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./output */ "./src/scripts/output.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./admin */ "./src/scripts/admin.js");
...
function fetchAndRetry(mailResp, waitTime, attempts) {
  ...
  function retry() {
    if (attempts > 0) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_4__.delay)(waitTime * (attempts + attempts)).then(() => fetchAndRetry(mailResp, waitTime, --attempts));
    }
  }
  return getSmtpLog(mailResp).then(logResp => {
    // Error
    if (logResp.status === 'error') {
      (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutput)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, `<code>${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('🆘 Failed!', 'cf7-smtp')}</code>`);
      if (logResp.message.length) {
        const errorLog = logResp.message.join();
        // then append the server response
        return (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutputMultiline)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, errorLog);
      }
      return (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutput)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, `<code>${logResp.message}</code>`);
    }

    // Quit
    if (logResp.message.match(/CLIENT -> SERVER: QUIT/g)) {
      return (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutput)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, `<code>${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('💻 server has closed the connection!', 'cf7-smtp')}</code>`);
    }

    // Success
    if (logResp.status === 'success') {
      return (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutput)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, `<code class="">${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('✅ Success!', 'cf7-smtp')}</code>`);
    }

    // otherwise if nothing match output the server response
    (0,_output__WEBPACK_IMPORTED_MODULE_1__.appendOutput)(_admin__WEBPACK_IMPORTED_MODULE_3__.responseBox, `<code>${logResp.message}</code>`);
    return retry();
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "appendOutput": function() { return /* binding */ appendOutput; },
/* harmony export */   "appendOutputMultiline": function() { return /* binding */ appendOutputMultiline; },
/* harmony export */   "cleanOutput": function() { return /* binding */ cleanOutput; }
/* harmony export */ });
...
function cleanOutput(logWrap) {
  ...
  const date = new Date();
  logWrap.innerHTML = `<code class="logdate alignright">${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Logs has been started in', 'cf7-smtp')} ${date}</code>` + message;
}
function appendOutput(logWrap) {
  let message = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
 ...
 */
function appendOutputMultiline(outputContainer, msg) {
  ...
  if (msg.length) {
    msg.forEach((line, index) => {
      ...
      const [raw, date, text] = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.extractData)(line);
      ...
      if (raw !== '') setTimeout(() => {
        if (!text) {
          ...
          lastTimestamp = date;
          appendOutput(outputContainer, `<span class="timestamp">${date}</span><code>${text}</code>`);
        }
      }, 50 * index);
    });
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mailCharts": function() { return /* binding */ mailCharts; }
/* harmony export */ });
...
function mailCharts() {
  if (typeof smtpReportData !== 'undefined' && 0 !== Object.keys(smtpReportData).length) {
    const cf7aCharts = {};
    ...
    for (const timestamp in smtpReportData.storage) {
      const day = new Date(timestamp * 1000).setHours(0, 0, 0, 0).valueOf();
    ...
    const lineConfig = {
      ...
      data: {
        ...
        labels: Object.keys(smtpReportData.lineData.failed).map(label => {
...
/* harmony export */   "enableAdvanced": function() { return /* binding */ enableAdvanced; },
...
/* harmony import */ var _scripts_admin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/admin */ "./src/scripts/admin.js");
