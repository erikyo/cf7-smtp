...
<div class="cf7-smtp-tester wrap">
	...
	<?php
	if ( defined( 'WP_DEBUG' ) ) {
		$cf7_smtp_options = cf7_smtp_obfuscate_options( $this->options );
		?>
		<div class="card">
			<h3><?php echo esc_html__( 'Debug Options', 'cf7-smtp' ); ?></h3>
			<pre><?php echo wp_json_encode( $cf7_smtp_options, JSON_PRETTY_PRINT ); ?></pre>
		</div>
	<?php } ?>
