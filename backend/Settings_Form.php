...
class Settings_Form  {
	...
	public function cf7_smtp_options_init() {
		...
		register_setting(
			...
			[ $this, 'cf7_smtp_sanitize_options' ]
		);
		...
		add_settings_section(
			...
			[ $this, 'cf7_smtp_print_section_main_subtitle' ],
			'smtp-settings'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_enable_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_preset_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_auth_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_host_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_port_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_user_name_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_user_pass_callback' ],
			'smtp-settings',
			'smtp_data'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_custom_template_callback' ],
			'smtp-settings',
			'smtp_advanced'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_advanced_callback' ],
			'smtp-settings',
			'smtp_advanced'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_from_mail_callback' ],
			'smtp-settings',
			'smtp_advanced'
		);
		...
		add_settings_field(
			...
			[ $this, 'cf7_smtp_print_from_name_callback' ],
			'smtp-settings',
			'smtp_advanced'
		);
	}
	...
	public function cf7_smtp_print_preset_callback() {
		$select_opt = '<option value="custom">custom</option>';
		printf(
	...
	public function cf7_smtp_print_auth_callback() {
		...
		printf(
			'<label><input type="radio" name="cf7-smtp-options[auth]" value="" %s />none</label>' .
			'<label><input type="radio" name="cf7-smtp-options[auth]" value="ssl" %s />ssl</label>' .
			'<label><input type="radio" name="cf7-smtp-options[auth]" value="tsl" %s />tsl</label>',
			'ssl' !== $auth_value && 'tsl' !== $auth_value  ? 'checked' : '',
			'ssl' === $auth_value ? 'checked' : '',
			'tsl' === $auth_value ? 'checked' : ''
		);
	}
